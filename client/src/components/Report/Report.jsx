            ...
            <div className="relative z-20">
                <div className="flex justify-between w-full text-sipe-white font-bold pt-7 px-10">
                    ...
                    <div className="flex flex-row gap-4 text-sipe-white">
                        ...
                        <Button onClick={() => setIsDeleteMode(!isDeleteMode)} className="bg-red-500 font-semibold px-4 py-2 rounded hover:bg-red-600">{isDeleteMode ? "CANCELAR ELIMINACIÓN" : "ELIMINAR INFORMES"}</Button>
                    </div>
                </div>
