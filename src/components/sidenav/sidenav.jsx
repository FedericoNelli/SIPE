...
function Sidenav() {
    ...
    return (
        <aside className="bg-sipe-blue-light text-sipe-white min-h-screen pl-12 py-8">
            <div className="">
                ...
                <section className='flex flex-col items-start'>
                    {sections.map((section, index) => (
                        <NavLink
                            ...
                            to={section.path}
                            className={({ isActive }) =>
                                `w-full text-left font-light text-sipe-white hover:bg-sipe-orange-dark hover:text-sipe-white rounded-l-lg px-3 py-3 ${isActive ? 'bg-sipe-orange-dark text-sipe-white' : 'text-zinc-400'}`
                            }
                        >
